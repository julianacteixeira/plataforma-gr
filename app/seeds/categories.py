...
CATEGORIES = [
    ...
    {"name": "ALL Signature Zen Day", "scope": "stay", "group_number": 1,
     "always_apply": True, "manual_only": False, "suggestion_priority": None,
     "opera_rate_code": "ALSIG1"},
    {"name": "ALL Signature Fondue", "scope": "stay", "group_number": 1,
     "always_apply": True, "manual_only": False, "suggestion_priority": None,
     "opera_rate_code": "ALSIG2"},
    {"name": "ALL Signature ALL Kids", "scope": "stay", "group_number": 1,
     "always_apply": True, "manual_only": False, "suggestion_priority": None,
     "opera_rate_code": "ALSIG3"},
    ...
    {"name": "Pedido de Desculpas", "scope": "stay", "group_number": 6,
     "always_apply": False, "manual_only": True, "suggestion_priority": 3},
